...
package uk.gov.hmrc.mobiletaskscheduler.repositories
...
object MongoPushUpdateFormats {
    ...
    val formats =
        ((__ \ "title").format[String]
            ~ (__ \ "subtitle").format[String]
            ~ (__ \ "isSomething").format[Boolean]
...
class ItemRepository @Inject()(
...
) extends WorkItemRepository[Item](
    collectionName = "ItemQueue",
    mongoComponent = mongoComponent,
    ...
    def pullOutstanding: Future[Option[WorkItem[Item]]] =
